...
if (isset($_POST['update_order'])) {
   ...
   $order_update_id = mysqli_real_escape_string($conn, $_POST['order_id']); // Sanitize user input
   $update_payment = mysqli_real_escape_string($conn, $_POST['update_payment']); // Sanitize user input
   $date = date("d.m.Y");
...
if (isset($_GET['delete'])) {
   $delete_id = mysqli_real_escape_string($conn, $_GET['delete']); // Sanitize user input
