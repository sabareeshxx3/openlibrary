...
<head>
    ...
    <style>
        ...
        .sub-menu-link {
            ...
            color: #525252;
            margin: 12px 0; /* Corrected margin property */
        }
...
<header>
    <div class="logo">
        <a href="index.php"><span>Open</span>
            <span class="me">Library</span></a>
    </div>
    <div class="nav">
    ...
    <div class="user-box" style="display: flex; align-items:center;">
        ...
        <?php if(isset($_SESSION['user_name'])) : ?>
            <img style="height:40px; margin-left:10px ;" src="images/ds2.png" class="user-pic" onclick="toggleMenu()" />
        <?php else : ?>
            <div class="use_links">
                <a class="link-btn" href="login.php">Login</a>
                <a class="link-btn" href="register.php">Register</a>
            </div>
        <?php endif; ?>
    </div>
</header>
