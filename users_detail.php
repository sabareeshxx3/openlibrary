...
<body>
    ...
    <section class="show-products">
        <div class="box-container">
            <?php
            $select_user = mysqli_query($conn, "SELECT Id, name, surname, email, password, user_type FROM users_info WHERE user_type = 'User' OR user_type = 'Admin'") or die('query failed');
            ...
            ?>
                    <div class="box">
                        ...
                        <div class="price" style="color:<?php echo $fetch_user['user_type'] == 'Admin' ? 'red' : 'blue'; ?>;">User type: <?php echo $fetch_user['user_type']; ?></div>
            ...
            ?>
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <select name="update_user_type" id="" required class="box">
                                <option value="User" <?php echo $fetch_update['user_type'] == 'User' ? 'selected' : ''; ?>>User</option>
                                <option value="Admin" <?php echo $fetch_update['user_type'] == 'Admin' ? 'selected' : ''; ?>>Admin</option>
                            </select>
