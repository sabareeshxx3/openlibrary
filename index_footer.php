        ...
        <div class="sub_main">
            <div class="short_links flex" style="justify-content:center; ">
                ...
                <ul>
                    ...
                    <li>+91 7025974317</li>
                    <li>contact@OpenLibrary.com</li>
                    <li>Address: kerala</li>
                </ul>

            </div>
        </div>
        <div style=" align-items:center; justify-content:center; margin:20px 0 0 ;" class="cmsg flex">
            <p>Designed By Sabareesh  | Copyright &copy; <script>
                    document.write(new Date().getFullYear())
                </script> All Rights are reserved by &nbsp</p>
            <div style="font-size: 30px;" class="logo">
                <a href="index.php"><span style="font-size: 15px;"> Open </span>
                    <span class="me" style="font-size: 15px;">Library</span></a>
            </div> 
        </div>
    </div>
</footer>