...
<head>
  ...
  <title>Open Library Admin</title>
</head>
...
<body>
  ...
  <div class="main_box">
    <div class="card" style="width: 15rem">
      ...
      <img class="card-img-top" src="./images/cart-dash (1).svg" alt="Card image cap" style="width: 100px; height: auto; padding-top: 20px;" />
      <div class="card-body">
    ...
    <div class="card" style="width: 15rem">
      ...
      ?>
      <img class="card-img-top" src="./images/cart-check-fill.svg" alt="Card image cap" style="width: 100px; height: auto; padding-top: 20px;" />
      <div class="card-body">
    ...
    <div class="card" style="width: 15rem">
      <img class="card-img-top" src="./images/cart.svg" alt="Card image cap" style="width: 100px; height: auto; padding-top: 20px;" />
      <div class="card-body">
    ...
    <div class="card" style="width: 15rem">
      <img class="card-img-top" src="./images/card-list.svg" alt="Card image cap" style="width: 100px; height: auto; padding-top: 20px;" />
      <div class="card-body">
    ...
    <div class="card" style="width: 15rem">
      <img class="card-img-top" src="./images/chat-left-dots.svg" alt="Card image cap" style="width: 100px; height: auto; padding-top: 20px;" />
      <div class="card-body">
    ...
    <div class="card" style="width: 15rem">
      <img class="card-img-top" src="./images/person.svg" alt="Card image cap" style="width: 100px; height: auto; padding-top: 20px;" />
      <div class="card-body">
    ...
    <div class="card" style="width: 15rem">
      <img class="card-img-top" src="./images/people.svg" alt="Card image cap" style="width: 100px; height: auto; padding-top: 20px;" />
      <div class="card-body">
