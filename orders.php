...
// Check if the payment status is updated to success
$success_message = '';
...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Payment Status : 
            <span style="color:<?php echo ($fetch_book['payment_status'] == 'pending') ? 'orange' : 'green'; ?>;">
                <?php echo $fetch_book['payment_status']; ?>
            </span> 
         </p>
         <?php if ($fetch_book['payment_status'] == 'success') {
            echo '<p>Payment status: <span style="color: green;">Success</span></p>';
         } ?>
      </div>
      <?php
            }
